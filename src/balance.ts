...
export async function increaseETHBalance(account: Addressish, amount: BigNumberish = ONE_ETH.mul(1000)) {
...
export async function setETHBalance(account: Addressish, newBalance: BigNumberish = ONE_ETH.mul(1000)) {
